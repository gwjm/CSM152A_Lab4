...
HD_PWD='C:/Users/Benji/BENJI SCHOOL/UCLA UNDERGRAD/116L/Final Project/CSM152A_Lab4/final_project/final_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log VGAdriver.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source VGAdriver.tcl
